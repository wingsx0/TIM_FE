...
const Layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex flex-col min-h-screen">
      <header className="py-8 px-14 bg-[#032541]">
        <svg
          width="92"
          height="32"
          viewBox="0 0 92 32"
      ...
      <div className="flex justify-center items-center h-full p-8">
        <div className="bg-[#E3FEF7] w-[45%] py-8">{children}</div>
      </div>
      <footer className="p-8 text-center bg-[#032541] text-white text-xs font-light mt-auto">
